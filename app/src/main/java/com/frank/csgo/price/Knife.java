...
public class Knife {
    ...
    // 折叠刀（★） | 深红之网 (略有磨损)
    public static double[] ZDD_SHZW_LM = {1650, 0.11, 1400};

    // 折叠刀（★） | 深红之网 (久经沙场)
    public static double[] ZDD_SHZW_JJ = {820, 0.20, 700};
    ...
    //   折叠刀（★） | 虎牙 (崭新出厂)
    public static double[] ZDD_HY_ZX = {900, 0.005, 750};

    //   刺刀（★） | 传说 (久经沙场)
    public static double[] CD_CS_JJ = {1680, 0.19, 1400};

    //   刺刀（★） | 自动化 (久经沙场)
    public static double[] CD_ZDH_JJ = {1399, 0.17, 1200};
    ...
    //   刺刀（★） | 虎牙 (崭新出厂)
    public static double[] CD_HY_ZX = {1350, 0.01, 1200};

    //    "M9 刺刀（★） | 虎牙 (崭新出厂)
    public static double[] M9_HY_ZX = {1630, 0.01, 1480};
    ...
    //猎杀者匕首（★） | 深红之网 (略有磨损)
    public static double[] LSZ_SHZW_LM = {1300, 0.09, 850};
    ...
    //熊刀（★） | 深红之网 (久经沙场)
    public static double[] XD_SHZW_JJ = {1600, 0.24, 1400};

    //短剑（★） | 深红之网 (略有磨损)
    public static double[] DJ_SHZW_LM = {1500, 0.10, 1300};

    //短剑（★） | 深红之网 (久经沙场)
    public static double[] DJ_SHZW_JJ = {800, 0.20, 620};

    //锯齿爪刀（★）
    public static double[] JCZD_WTZ= {1800, 0.10, 1600};

    //锯齿爪刀（★）|深红之网 (久经沙场)
    public static double[] JCZD_CS_JJ = {1600, 0.20, 1340};
}
