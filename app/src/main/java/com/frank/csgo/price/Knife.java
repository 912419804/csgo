...
public class Knife {
    ...
    //   M9 刺刀（★） | 深红之网 (略有磨损)
    public static double[] M9_SHZW_LM = {4300, 0.12, 3400};
    ...
    //   M9 刺刀（★） | 深红之网 (久经沙场)
    public static double[] M9_SHZW_JJ = {1450, 0.25, 1150};
    public static double[] M9_SHZW_JJ_2 = {1450, 0.25, 1150};
    ...
    //爪子刀（★） | 自动化 (久经沙场)
    public static double[] ZZD_ZDH_JJ = {2750, 0.20, 2400};
    ...
    //爪子刀（★） | 深红之网 (久经沙场)
    public static double[] ZZD_SHZW_JJ = {1900, 0.25, 1600};
    ...
    //熊刀（★） | 深红之网 (久经沙场)
    public static double[] XD_SHZW_JJ = {1750, 0.20, 1450};
    ...
    //锯齿爪刀（★）
    public static double[] JCZD_WTZ= {1600, 0.10, 1400};
    ...
    //锯齿爪刀（★）|深红之网 (久经沙场)
    public static double[] JCZD_SHZW_JJ = {1550, 0.24, 1300};
    ...
    //锯齿爪刀（★） | 致命紫罗兰 (久经沙场)
    public static double[] JCZD_ZMZLL_JJ= {1140, 0.19, 900};
    ...
    //熊刀（★） | 致命紫罗兰 (久经沙场)
    public static double[] XD_ZMZLL_JJ = {1050, 0.21, 850};
    ...
    //猎杀者匕首（★） | 致命紫罗兰 (略有磨损)
    public static double[] LSZ_ZMZLL_LM = {710, 0.09, 600};
