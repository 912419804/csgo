...
public class Knife {
    ...
    // 折叠刀（★） | 深红之网 (略有磨损)
    public static double[] ZDD_SHZW_LM = {1650, 0.12, 1400};
    ...
    // 折叠刀（★） | 深红之网 (久经沙场)
    public static double[] ZDD_SHZW_JJ = {820, 0.25, 700};
    ...
    //   折叠刀（★） | 虎牙 (崭新出厂)
    public static double[] ZDD_HY_ZX = {1000, 0.005, 800};
    ...
    //   刺刀（★） | 自动化 (久经沙场)
    public static double[] CD_ZDH_JJ = {1500, 0.17, 1300};
    ...
    //   蝴蝶刀（★） | 北方森林 (久经沙场)
    public static double[] HDD_BFSL_JJ = {900, 0.17, 740};
    ...
    //爪子刀 无涂装
    public static double[] ZZD_WTZ = {1600, 0.07, 1400};
    ...
    //爪子刀（★） | 森林 DDPAT (略有磨损)
    public static double[] ZZD_SLD_LM = {950, 0.08, 700};
    ...
    //爪子刀（★） | 森林 DDPAT (久经沙场)
    public static double[] ZZD_SLD_JJ = {730, 0.16, 600};
    ...
    //爪子刀（★） | 北方森林 (略有磨损)
    public static double[] ZZD_BFSL_LM = {1100, 0.08, 850};
    ...
    //爪子刀（★） | 北方森林 (久经沙场)
    public static double[] ZZD_BFSL_JJ = {840, 0.17, 700};
    ...
    //猎杀者匕首（★） | 深红之网 (略有磨损)
    public static double[] LSZ_SHZW_LM = {1200, 0.11, 850};
    ...
    //熊刀（★） | 深红之网 (久经沙场)
    public static double[] XD_SHZW_JJ = {1740, 0.24, 1500};
    ...
    //短剑（★） | 深红之网 (略有磨损)
    public static double[] DJ_SHZW_LM = {1750, 0.11, 1400};
    public static String[] DJ_SHZW_LM_URL = {""};
    ...
    //短剑（★） | 深红之网 (久经沙场)
    public static double[] DJ_SHZW_JJ = {800, 0.21, 620};
    ...
    //   蝴蝶刀（★） | 噩梦之夜 (略有磨损)
    public static double[] HDD_EMZY_LM = {1700, 0.11, 1500};
    public static String[] HDD_EMZY_LM_URL = {""};
    ...
    //   蝴蝶刀（★） | 噩梦之夜 (久经沙场)
    public static double[] HDD_EMZY_JJ = {1100, 0.18, 900};
    public static String[] HDD_EMZY_JJ_URL = {""};
    ...
    //刺刀（★） | 噩梦之夜 (略有磨损)
    public static double[] CD_EMZY_LM = {950, 0.10, 800};
    public static String[] CD_EMZY_LM_URL = {""};
    ...
    //M9刺刀（★） | 噩梦之夜 (久经沙场)
    public static double[] M9_EMZY_JJ = {800, 0.22, 680};
    public static String[] M9_EMZY_JJ_URL = {""};
    ...
    //爪子刀（★） | 噩梦之夜 (久经沙场)
    public static double[] ZZD_EMZY_JJ = {1150, 0.17, 1000};
    public static String[] ZZD_EMZY_JJ_URL = {""};
    ...
    //爪子刀（★） | 噩梦之夜 (略有磨损)
    public static double[] ZZD_EMZY_LM = {1650, 0.11, 1400};
    public static String[] ZZD_EMZY_LM_URL = {""};
    ...
    //熊刀（★） | 噩梦之夜 (久经沙场)
    public static double[] XD_EMZY_JJ = {1200, 0.18, 1000};
    public static String[] XD_EMZY_JJ_URL = {""};
    public static Object[] XD_EMZY_JJ_MAP = {N_XD_EMZY_JJ,XD_EMZY_JJ_URL,XD_EMZY_JJ};
    static {KNIFE_DATA.put(XD_EMZY_JJ_MAP[0],XD_EMZY_JJ_MAP);}

    //猎杀者匕首（★） | 噩梦之夜 (略有磨损)
    public static double[] LSZ_EMZY_LM = {750, 0.09, 600};
    public static String[] LSZ_EMZY_LM_URL = {""};
