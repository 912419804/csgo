...
public class Glove {
    ...
    //  裹手（★） | 钴蓝骷髅 (久经沙场)
    public static double[] GS_GLKL_JJ = {3100, 0.26, 2500};
    ...
    //  运动手套（★） | 树篱迷宫 (久经沙场)
    public static double[] YD_SLMG_JJ = {3300, 0.30, 2700};
    ...
    //  运动手套（★） | 双栖(久经沙场)
    public static double[] YD_SX_JJ = {2700, 0.26, 2300};
    ...
    // 九头蛇手套（★） | 响尾蛇(久经沙场)
    public static double[] JTS_XWS_JJ = {720, 0.17, 600};
