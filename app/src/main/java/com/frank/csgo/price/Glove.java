...
public class Glove {
    ...
    static {
        GLOVE_DATA.put(XL_JT_LM_MAP[0],XL_JT_LM_MAP);}
    ...
    static {
        GLOVE_DATA.put(XL_JT_JJ_MAP[0],XL_JT_JJ_MAP);}
    ...
    static {
        GLOVE_DATA.put(XL_SY_LM_MAP[0],XL_SY_LM_MAP);}
    ...
    static {
        GLOVE_DATA.put(XL_SY_JJ_MAP[0],XL_SY_JJ_MAP);}
    ...
    static {
        GLOVE_DATA.put(XL_RT_LM_MAP[0],XL_RT_LM_MAP);}
    ...
    static {
        GLOVE_DATA.put(XL_RT_JJ_MAP[0],XL_RT_JJ_MAP);}

    // 血猎手套（★） | 游击队 (略有磨损)
    public static double[] XL_YJD_LM = {1550, 0.11, 1250};
    ...
    static {
        GLOVE_DATA.put(XL_YJD_LM_MAP[0],XL_YJD_LM_MAP);}
    ...
    static {
        GLOVE_DATA.put(XL_YJD_JJ_MAP[0],XL_YJD_JJ_MAP);}
    ...
    // 驾驶手套（★） | 紫蓝格子 (久经沙场)
    public static double[] XL_LZGZ_JJ = {1900, 0.23, 1610};
    ...
    static {
        GLOVE_DATA.put(XL_LZGZ_JJ_MAP[0],XL_LZGZ_JJ_MAP);}

    // 驾驶手套（★） | 王蛇 (久经沙场)
    public static double[] XL_WS_JJ = {1650, 0.24, 1410};
    public static String[] XL_WS_JJ_URL = {"https://buff.163.com/api/market/goods/sell_order?game=csgo&goods_id=45549&page_num=1&sort_by=default&mode=&allow_tradable_cooldown=1&_=1554969156076"};
    public static Object[] XL_WS_JJ_MAP = {N_XL_WS_JJ,XL_WS_JJ_URL,XL_WS_JJ};
    static {
        GLOVE_DATA.put(XL_WS_JJ_MAP[0],XL_WS_JJ_MAP);}

    // 驾驶手套（★） | 月色织物 (略有磨损)
    public static double[] XL_YSZW_LM = {1600, 0.12, 1310};
    ...
    static {
        GLOVE_DATA.put(XL_YSZW_LM_MAP[0],XL_YSZW_LM_MAP);}
    ...
    static {
        GLOVE_DATA.put(XL_YSZW_JJ_MAP[0],XL_YSZW_JJ_MAP);}

    //  驾驶手套（★） | 超越 (略有磨损)
    public static double[] JS_CY_LM = {1580, 0.10, 1420};
    ...
    static {
        GLOVE_DATA.put(JS_CY_LM_MAP[0],JS_CY_LM_MAP);}

    //  驾驶手套（★） | 超越 (久经沙场)
    public static double[] JS_CY_JJ = {850, 0.22, 680};
    ...
    static {
        GLOVE_DATA.put(JS_CY_JJ_MAP[0],JS_CY_JJ_MAP);}

    //  驾驶手套（★） | 菱背蛇纹 (略有磨损)
    public static double[] JS_LBSW_LM = {1000, 0.09, 800};
    ...
    static {
        GLOVE_DATA.put(JS_LBSW_LM_MAP[0],JS_LBSW_LM_MAP);}

    //  驾驶手套（★） | 护卫 (略有磨损)
    public static double[] JS_HW_LM = {700, 0.08, 600};
    ...
    static {
        GLOVE_DATA.put(JS_HW_LM_MAP[0],JS_HW_LM_MAP);}
    ...
    static {
        GLOVE_DATA.put(JS_MLSD_LM_MAP[0],JS_MLSD_LM_MAP);}

    //  裹手（★） | 钴蓝骷髅 (久经沙场)
    public static double[] GS_GLKL_JJ = {3100, 0.25, 2600};
    ...
    static {
        GLOVE_DATA.put(GS_GLKL_JJ_MAP[0],GS_GLKL_JJ_MAP);}


    //  裹手（★） | 屠夫 (略有磨损)
    public static double[] GS_TF_LM = {2900, 0.12, 2500};
    ...
    static {
        GLOVE_DATA.put(GS_TF_LM_MAP[0],GS_TF_LM_MAP);}
    ...
    static {
        GLOVE_DATA.put(GS_TF_JJ_MAP[0],GS_TF_JJ_MAP);}
    ...
    static {
        GLOVE_DATA.put(GS_ET_LM_MAP[0],GS_ET_LM_MAP);}
    ...
    static {
        GLOVE_DATA.put(GS_PG_LM_MAP[0],GS_PG_LM_MAP);}

    //  裹手（★） | 皮革 (久经沙场)
    public static double[] GS_PG_JJ = {900, 0.20, 750};
    public static String[] GS_PG_JJ_URL = {"https://buff.163.com/api/market/goods/sell_order?game=csgo&goods_id=42879&page_num=1&sort_by=default&mode=&allow_tradable_cooldown=1&_=1554971486082"};
    public static Object[] GS_PG_JJ_MAP = {N_GS_PG_JJ,GS_PG_JJ_URL, GS_PG_JJ};
    static {
        GLOVE_DATA.put(GS_PG_JJ_MAP[0],GS_PG_JJ_MAP);}

    //  裹手（★） | 森林色调 (略有磨损)
    public static double[] GS_SLSD_LM = {1300, 0.11, 1100};
    ...
    static {
        GLOVE_DATA.put(GS_SLSD_LM_MAP[0],GS_SLSD_LM_MAP);}

    //  裹手（★） | 森林色调 (久经沙场)
    public static double[] GS_SLSD_JJ = {820, 0.22, 700};
    ...
    static {
        GLOVE_DATA.put(GS_SLSD_JJ_MAP[0],GS_SLSD_JJ_MAP);}
    ...
    static {
        GLOVE_DATA.put(GS_YS_LM_MAP[0],GS_YS_LM_MAP);}
    ...
    static {
        GLOVE_DATA.put(GS_BH_JJ_MAP[0],GS_BH_JJ_MAP);}
    ...
    static {
        GLOVE_DATA.put(MT_QLBH_LM_MAP[0],MT_QLBH_LM_MAP);}
    ...
    static {
        GLOVE_DATA.put(MT_QLBH_JJ_MAP[0],MT_QLBH_JJ_MAP);}

    //  摩托手套（★） | *嘣！* (略有磨损)
    public static double[] MT_B_LM = {2450, 0.12, 2100};
    ...
    static {
        GLOVE_DATA.put(MT_B_LM_MAP[0],MT_B_LM_MAP);}

    //  摩托手套（★） | *嘣！* (久经沙场)
    public static double[] MT_B_JJ = {1150, 0.30, 1000};
    ...
    static {
        GLOVE_DATA.put(MT_B_JJ_MAP[0],MT_B_JJ_MAP);}

    //  摩托手套（★） | 嘭！ (久经沙场)
    public static double[] MT_P_LM = {2200, 0.31, 1900};
    ...
    static {
        GLOVE_DATA.put(MT_P_LM_MAP[0],MT_P_LM_MAP);}

    //  摩托手套（★） | 交运 (略有磨损)
    public static double[] MT_JY_LM = {1450, 0.12, 1200};
    ...
    static {
        GLOVE_DATA.put(MT_JY_LM_MAP[0],MT_JY_LM_MAP);}

    //  摩托手套（★） | 交运 (久经沙场)
    public static double[] MT_JY_JJ = {780, 0.23, 600};
    ...
    static {
        GLOVE_DATA.put(MT_JY_JJ_MAP[0],MT_JY_JJ_MAP);}

    //  摩托手套（★） | 多边形 (久经沙场)
    public static double[] MT_DBX_JJ = {1550, 0.25, 1350};
    ...
    static {
        GLOVE_DATA.put(MT_DBX_JJ_MAP[0],MT_DBX_JJ_MAP);}

    //  摩托手套（★） | 玳瑁 (久经沙场)
    public static double[] MT_DM_JJ = {1650, 0.25, 1350};
    ...
    static {
        GLOVE_DATA.put(MT_DM_JJ_MAP[0],MT_DM_JJ_MAP);}
    ...
    static {
        GLOVE_DATA.put(MT_RS_LM_MAP[0],MT_RS_LM_MAP);}
    ...
    static {
        GLOVE_DATA.put(MT_RS_JJ_MAP[0],MT_RS_JJ_MAP);}
    ...
    static {
        GLOVE_DATA.put(ZY_SHHF_JJ_MAP[0],ZY_SHHF_JJ_MAP);}

    //  专业手套（★） | 深红之网 (略有磨损)
    public static double[] ZY_SHZW_LM = {3800, 0.122, 3400};
    ...
    static {
        GLOVE_DATA.put(ZY_SHZW_LM_MAP[0],ZY_SHZW_LM_MAP);}
    ...
    static {
        GLOVE_DATA.put(ZY_SHZW_JJ_MAP[0],ZY_SHZW_JJ_MAP);}
    ...
    static {
        GLOVE_DATA.put(ZY_DW_LM_MAP[0],ZY_DW_LM_MAP);}
    ...
    static {
        GLOVE_DATA.put(ZY_DW_JJ_MAP[0],ZY_DW_JJ_MAP);}

    //  专业手套（★） | 元勋 (略有磨损)
    public static double[] ZY_YX_LM = {3000, 0.11, 2700};
    ...
    static {
        GLOVE_DATA.put(ZY_YX_LM_MAP[0],ZY_YX_LM_MAP);}

    //  专业手套（★） | 元勋 (久经沙场)
    public static double[] ZY_YX_JJ = {1550, 0.25, 1250};
    ...
    static {
        GLOVE_DATA.put(ZY_YX_JJ_MAP[0],ZY_YX_JJ_MAP);}
    ...
    static {
        GLOVE_DATA.put(ZY_JBZS_JJ_MAP[0],ZY_JBZS_JJ_MAP);}

    //  专业手套（★） | 翠绿之网 (久经沙场)
    public static double[] ZY_CLZW_JJ = {2050, 0.25, 1800};
    ...
    static {
        GLOVE_DATA.put(ZY_CLZW_JJ_MAP[0],ZY_CLZW_JJ_MAP);}
    ...
    static {
        GLOVE_DATA.put(ZY_SL_LM_MAP[0],ZY_SL_LM_MAP);}

    //  专业手套（★） | 狩鹿(久经沙场)
    public static double[] ZY_SL_JJ = {620, 0.16, 500};
    ...
    static {
        GLOVE_DATA.put(ZY_SL_JJ_MAP[0],ZY_SL_JJ_MAP);}

    //  专业手套（★） | 森林 DDPAT (略有磨损)
    public static double[] ZY_SLD_LM = {1000, 0.08, 780};
    ...
    static {
        GLOVE_DATA.put(ZY_SLD_LM_MAP[0],ZY_SLD_LM_MAP);}
    ...
    static {
        GLOVE_DATA.put(ZY_SLD_JJ_MAP[0],ZY_SLD_JJ_MAP);}
    ...
    static {
        GLOVE_DATA.put(YD_PDLZH_JJ_MAP[0],YD_PDLZH_JJ_MAP);}
    ...
    static {
        GLOVE_DATA.put(YD_MAMFY_JJ_MAP[0],YD_MAMFY_JJ_MAP);}
    ...
    static {
        GLOVE_DATA.put(YD_CDT_JJ_MAP[0],YD_CDT_JJ_MAP);}
    ...
    static {
        GLOVE_DATA.put(YD_SLMG_JJ_MAP[0],YD_SLMG_JJ_MAP);}

    //  运动手套（★） | 双栖(久经沙场)
    public static double[] YD_SX_JJ = {2550, 0.28, 2300};
    ...
    static {
        GLOVE_DATA.put(YD_SX_JJ_MAP[0],YD_SX_JJ_MAP);}

    //  运动手套（★） | 欧米伽(久经沙场)
    public static double[] YD_OMJ_JJ = {2200, 0.28, 1800};
    ...
    static {
        GLOVE_DATA.put(YD_OMJ_JJ_MAP[0],YD_OMJ_JJ_MAP);}

    // 九头蛇手套（★） | 表面淬火(略有磨损)
    public static double[] JTS_BMCH_LM = {1800, 0.12, 1500};
    ...
    static {
        GLOVE_DATA.put(JTS_BMCH_LM_MAP[0],JTS_BMCH_LM_MAP);}

    // 九头蛇手套（★） | 表面淬火(久经沙场)
    public static double[] JTS_BMCH_JJ = {1020, 0.22, 800};
    ...
    static {
        GLOVE_DATA.put(JTS_BMCH_JJ_MAP[0],JTS_BMCH_JJ_MAP);}
    ...
    static {
        GLOVE_DATA.put(JTS_FCSD_LM_MAP[0],JTS_FCSD_LM_MAP);}

    // 九头蛇手套（★） | 翡翠色调(久经沙场)
    public static double[] JTS_FCSD_JJ = {900, 0.24, 750};
    ...
    static {
        GLOVE_DATA.put(JTS_FCSD_JJ_MAP[0],JTS_FCSD_JJ_MAP);}

    // 九头蛇手套（★） | 响尾蛇(略有磨损)
    public static double[] JTS_XWS_LM = {1250, 0.12, 1000};
    ...
    static {
        GLOVE_DATA.put(JTS_XWS_LM_MAP[0],JTS_XWS_LM_MAP);}

    // 九头蛇手套（★） | 响尾蛇(久经沙场)
    public static double[] JTS_XWS_JJ = {800, 0.23, 690};
    ...
    static {
        GLOVE_DATA.put(JTS_XWS_JJ_MAP[0],JTS_XWS_JJ_MAP);}
