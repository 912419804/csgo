...
public class Glove {
    ...
    // 血猎手套（★） | 蛇咬 (略有磨损)
    public static double[] XL_SY_LM = {2200, 0.12, 1820};
    ...
    // 血猎手套（★） | 蛇咬 (久经沙场)
    public static double[] XL_SY_JJ = {1050, 0.24, 940};
    ...
    // 血猎手套（★） | 染铜 (略有磨损)
    public static double[] XL_RT_LM = {1500, 0.12, 1300};
    ...
    // 血猎手套（★） | 游击队 (略有磨损)
    public static double[] XL_YJD_LM = {1590, 0.12, 1350};
    ...
    // 驾驶手套（★） | 紫蓝格子 (略有磨损)
    public static double[] XL_LZGZ_LM = {4400, 0.123, 3800};
    ...
    // 驾驶手套（★） | 紫蓝格子 (久经沙场)
    public static double[] XL_LZGZ_JJ = {2222, 0.27, 1810};
    ...
    // 驾驶手套（★） | 月色织物 (略有磨损)
    public static double[] XL_YSZW_LM = {1900, 0.113, 1610};
    ...
    //  裹手（★） | 屠夫 (久经沙场)
    public static double[] GS_TF_JJ = {2000, 0.24, 1600};
    ...
    //  裹手（★） | 恶土 (久经沙场)
    public static double[] GS_ET_JJ = {1250, 0.23, 1000};
    ...
    //  摩托手套（★） | 薄荷 (久经沙场)
    public static double[] GS_BH_JJ = {4500, 0.32, 3800};
    ...
    //  摩托手套（★） | 清凉薄荷 (略有磨损)
    public static double[] MT_QLBH_LM = {4500, 0.12, 3800};
    ...
    //  摩托手套（★） | 清凉薄荷 (久经沙场)
    public static double[] MT_QLBH_JJ = {1850, 0.29, 1600};
    ...
    //  摩托手套（★） | 多边形 (久经沙场)
    public static double[] MT_DBX_JJ = {1700, 0.25, 1500};
    ...
    //  摩托手套（★） | 玳瑁 (久经沙场)
    public static double[] MT_DM_JJ = {1700, 0.28, 1450};
    ...
    //  专业手套（★） | 渐变之色 (久经沙场)
    public static double[] ZY_JBZS_JJ = {2650, 0.27, 2100};
    ...
    //  专业手套（★） | 狩鹿(略有磨损)
    public static double[] ZY_SL_LM = {1100, 0.09, 850};
    ...
    //  专业手套（★） | 狩鹿(久经沙场)
    public static double[] ZY_SL_JJ = {680, 0.16, 550};
    ...
    //  专业手套（★） | 森林 DDPAT (略有磨损)
    public static double[] ZY_SLD_LM = {1110, 0.08, 900};
    ...
    //  运动手套（★） | 潘多拉之盒(久经沙场)
    public static double[] YD_PDLZH_JJ = {7500, 0.31, 6400};
    ...
    //  运动手套（★） | 迈阿密风云(久经沙场)
    public static double[] YD_MAMFY_JJ = {6400, 0.30, 5800};
    ...
    //  运动手套（★） | 树篱迷宫 (久经沙场)
    public static double[] YD_SLMG_JJ = {3500, 0.30, 3000};
    ...
    //  运动手套（★） | 双栖(久经沙场)
    public static double[] YD_SX_JJ = {3100, 0.27, 2700};
    ...
    //  运动手套（★） | 欧米伽(久经沙场)
    public static double[] YD_OMJ_JJ = {2700, 0.27, 2300};
    ...
    //  运动手套（★） | 青铜形态 (久经沙场)
    public static double[] YD_QTXT_JJ = {1490, 0.20, 1200};
    ...
    //  运动手套（★） | 干旱 (久经沙场)
    public static double[] YD_GH_JJ = {1800, 0.25, 1500};
    ...
    // 九头蛇手套（★） | 响尾蛇(略有磨损)
    public static double[] JTS_XWS_LM = {1250, 0.11, 1000};
    ...
    // 九头蛇手套（★） | 响尾蛇(久经沙场)
    public static double[] JTS_XWS_JJ = {800, 0.18, 690};
