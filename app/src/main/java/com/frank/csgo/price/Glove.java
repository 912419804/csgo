...
public class Glove {
    ...
    // 驾驶手套（★） | 深红织物 (久经沙场)
    public static double[] XL_SHZW_JJ = {1860, 0.27, 1500};
    ...
    // 驾驶手套（★） | 王蛇 (久经沙场)
    public static double[] XL_WS_JJ = {2100, 0.25, 1600};
    ...
    //  驾驶手套（★） | 月色织物 (久经沙场)
    public static double[] XL_YSZW_JJ = {670, 0.22, 500};
    ...
    //裹手（★） | 套印(久经沙场)
    public static double[] GS_TY_JJ = {1830, 0.25, 1450};
    ...
    //  裹手（★） | 钴蓝骷髅 (久经沙场)
    public static double[] GS_GLKL_JJ = {2790, 0.26, 2200};
    ...
    //  裹手（★） | 恶土 (久经沙场)
    public static double[] GS_ET_JJ = {960, 0.20, 780};
    ...
    //  裹手（★） | 皮革 (久经沙场)
    public static double[] GS_PG_JJ = {920, 0.20, 700};
    ...
    //  裹手（★） | 长颈鹿 (久经沙场)
    public static double[] GS_CJL_JJ = {800, 0.23, 700};
    //  裹手（★） | 长颈鹿 (略有磨损)
    public static double[] GS_CJL_LM = {1400, 0.10, 1200};
    //  裹手（★） | 沙漠头巾 (久经沙场)
    public static double[] GS_SMTJ_JJ = {450, 0.17, 380};
    //  裹手（★） | 沙漠头巾 (略有磨损)
    public static double[] GS_SMTJ_LM = {1400, 0.10, 1200};

    //  裹手（★） | 蟒蛇 (久经沙场)
    public static double[] GS_MS_JJ = {500, 0.17, 400};
    //  裹手（★） | 警告！ (久经沙场)
    public static double[] GS_JG_JJ = {1700, 0.25, 1500};
    //  裹手（★） | 警告！ (略有磨损)
    public static double[] GS_JG_LM = {3500, 0.11, 3000};

    //  摩托手套（★） | 第三特种兵连 (久经沙场)
    public static double[] MT_DSTZBL_JJ = {450, 0.25, 520};
    //  摩托手套（★） | 第三特种兵连 (略有磨损)
    public static double[] MT_DSTZBL_LM = {1100, 0.10, 900};
    //  摩托手套（★） | 血压 (久经沙场)
    public static double[] MT_XY_JJ = {1000, 0.27, 1150};
    //  摩托手套（★） | 血压 (略有磨损)
    public static double[] MT_XY_LM = {3200, 0.10, 3800};
    //  摩托手套（★） | 终点线 (久经沙场)
    public static double[] MT_ZDX_JJ = {1200, 0.30, 1000};
    //  摩托手套（★） | 小心烟幕弹 (久经沙场)
    public static double[] MT_XXYMD_JJ = {1400, 0.29, 1200};
    ...
    //  摩托手套（★） | 清凉薄荷 (久经沙场)
    public static double[] MT_QLBH_JJ = {1620, 0.29, 1300};
    ...
    //  摩托手套（★） | 嘭！ (久经沙场)
    public static double[] MT_P_LM = {2200, 0.31, 1800};
    ...
    //  摩托手套（★） | 玳瑁 (久经沙场)
    public static double[] MT_DM_JJ = {1480, 0.28, 1200};
    ...
    //  专业手套（★） | 一线特工 (久经沙场)
    public static double[] ZY_YXTG_JJ= {1900, 0.27, 1700};
    //  专业手套（★） | 老虎精英 (久经沙场)
    public static double[] ZY_LHJY_JJ= {3800, 0.29, 3200};
    //  专业手套（★） | 陆军少尉长官 (久经沙场)
    public static double[] ZY_LJSWZG_JJ= {1400, 0.29, 1200};
    //  专业手套（★） | 渐变大理石 (久经沙场)
    public static double[] ZY_JBDLS_JJ= {1400, 0.29, 1200};

    //  专业手套（★） | 深红和服 (久经沙场)
    public static double[] ZY_SHHF_JJ= {3380, 0.22, 2800};
    ...
    //  专业手套（★） | 深红之网 (久经沙场)
    public static double[] ZY_SHZW_JJ = {1560, 0.26, 1300};
    ...
    //  专业手套（★） | 大腕 (略有磨损)
    public static double[] ZY_DW_LM = {2800, 0.10, 2200};
    ...
    //  运动手套（★） | 大型猎物 (久经沙场)
    public static double[] YD_DXLW_JJ = {1900, 0.26, 1700};
    //  运动手套（★） | 弹弓 (久经沙场)
    public static double[] YD_DG_JJ = {1900, 0.29, 1700};
    //  运动手套（★） | 夜行衣 (久经沙场)
    public static double[] YD_YXY_JJ = {1800, 0.28, 1600};
    //  运动手套（★） | 猩红头巾 (久经沙场)
    public static double[] YD_XHTJ_JJ = {1800, 0.28, 1600};

    //  运动手套（★） | 潘多拉之盒(久经沙场)
    public static double[] YD_PDLZH_JJ = {6700, 0.32, 6000};
    ...
    //  运动手套（★） | 迈阿密风云(久经沙场)
    public static double[] YD_MAMFY_JJ = {5500, 0.29, 4600};
    ...
    //  运动手套（★） | 超导体 (久经沙场)
    public static double[] YD_CDT_JJ = {3600, 0.29, 3050};
    ...
    //  运动手套（★） | 树篱迷宫 (久经沙场)
    public static double[] YD_SLMG_JJ = {3100, 0.30, 2500};
    ...
    //  运动手套（★） | 双栖(久经沙场)
    public static double[] YD_SX_JJ = {2800, 0.26, 2200};
    ...
    //  运动手套（★） | 欧米伽(久经沙场)
    public static double[] YD_OMJ_JJ = {2300, 0.26, 1900};
    ...
    //  运动手套（★） | 青铜形态 (久经沙场)
    public static double[] YD_QTXT_JJ = {1180, 0.20, 900};
    ...
    //  运动手套（★） | 干旱 (久经沙场)
    public static double[] YD_GH_JJ = {1540, 0.25, 1200};
    ...
    // 九头蛇手套（★） | 表面淬火(略有磨损)
    public static double[] JTS_BMCH_LM = {1250, 0.09, 1050};
    ...
    // 九头蛇手套（★） | 表面淬火(久经沙场)
    public static double[] JTS_BMCH_JJ = {800, 0.20, 600};
    ...
    // 九头蛇手套（★） | 翡翠色调(略有磨损)
    public static double[] JTS_FCSD_LM = {1100, 0.10, 900};
    ...
    // 九头蛇手套（★） | 翡翠色调(久经沙场)
    public static double[] JTS_FCSD_JJ = {690, 0.19, 520};
    ...
    //九头蛇手套（★） | 红树林(略有磨损)
    public static double[] JTS_HSL_LM = {680, 0.09, 550};
