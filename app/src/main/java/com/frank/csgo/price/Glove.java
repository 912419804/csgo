...
public class Glove {
    ...
    // 血猎手套（★） | 蛇咬 (略有磨损)
    public static double[] XL_SY_LM = {2100, 0.11, 1500};
    ...
    // 血猎手套（★） | 蛇咬 (久经沙场)
    public static double[] XL_SY_JJ = {1000, 0.23, 750};
    ...
    // 血猎手套（★） | 染铜 (略有磨损)
    public static double[] XL_RT_LM = {1500, 0.10, 1100};
    ...
    // 驾驶手套（★） | 紫蓝格子 (久经沙场)
    public static double[] XL_LZGZ_JJ = {1950, 0.26, 1500};
    ...
    // 驾驶手套（★） | 王蛇 (久经沙场)
    public static double[] XL_WS_JJ = {2100, 0.25, 1700};
    ...
    //  驾驶手套（★） | 月色织物 (久经沙场)
    public static double[] XL_YSZW_JJ = {800, 0.22, 600};
    ...
    //  驾驶手套（★） | 超越 (久经沙场)
    public static double[] JS_CY_JJ = {850, 0.21, 600};
    ...
    //  裹手（★） | 钴蓝骷髅 (久经沙场)
    public static double[] GS_GLKL_JJ = {3000, 0.26, 2500};
    ...
    //  裹手（★） | 屠夫 (久经沙场)
    public static double[] GS_TF_JJ = {1800, 0.24, 1350};
    ...
    //  裹手（★） | 恶土 (久经沙场)
    public static double[] GS_ET_JJ = {1100, 0.23, 900};
    ...
    //  裹手（★） | 皮革 (略有磨损)
    public static double[] GS_PG_LM = {1990, 0.10, 1500};
    ...
    //  裹手（★） | 皮革 (久经沙场)
    public static double[] GS_PG_JJ = {1050, 0.20, 850};
    ...
    //  裹手（★） | 森林色调 (略有磨损)
    public static double[] GS_SLSD_LM = {1300, 0.10, 1100};
    ...
    //  裹手（★） | 森林色调 (久经沙场)
    public static double[] GS_SLSD_JJ = {890, 0.19, 710};
    ...
    //  摩托手套（★） | 嘭！ (久经沙场)
    public static double[] MT_P_LM = {2350, 0.31, 1900};
    ...
    //  专业手套（★） | 翠绿之网 (久经沙场)
    public static double[] ZY_CLZW_JJ = {2000, 0.25, 1500};
    ...
    //  运动手套（★） | 潘多拉之盒(久经沙场)
    public static double[] YD_PDLZH_JJ = {6900, 0.31, 6000};
    ...
    //  运动手套（★） | 迈阿密风云(久经沙场)
    public static double[] YD_MAMFY_JJ = {5900, 0.30, 5000};
    ...
    //  运动手套（★） | 超导体 (久经沙场)
    public static double[] YD_CDT_JJ = {3800, 0.30, 3200};
    ...
    //  运动手套（★） | 树篱迷宫 (久经沙场)
    public static double[] YD_SLMG_JJ = {3200, 0.30, 2700};
    ...
    //  运动手套（★） | 双栖(久经沙场)
    public static double[] YD_SX_JJ = {2700, 0.26, 2200};
    ...
    //  运动手套（★） | 青铜形态 (久经沙场)
    public static double[] YD_QTXT_JJ = {1200, 0.20, 980};
    ...
    //  运动手套（★） | 干旱 (久经沙场)
    public static double[] YD_GH_JJ = {1650, 0.25, 1300};
    ...
    // 九头蛇手套（★） | 响尾蛇(久经沙场)
    public static double[] JTS_XWS_JJ = {670, 0.16, 580};
    ...
    //裹手（★） | 套印(久经沙场)
    public static double[] GS_TY_JJ = {2100, 0.25, 1600};
