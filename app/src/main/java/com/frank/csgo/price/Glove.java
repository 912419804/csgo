...
public class Glove {
    ...
    //  驾驶手套（★） | 超越 (久经沙场)
    public static double[] JS_CY_JJ= {850, 0.20, 680};
    ...
    //  摩托手套（★） | 交运 (略有磨损)
    public static double[] MT_JY_LM = {1500, 0.09, 1200};

    //  摩托手套（★） | 交运 (久经沙场)
    public static double[] MT_JY_JJ = {780, 0.18, 600};
    ...
    //  运动手套（★） | 树篱迷宫(久经沙场)
    public static double[] YD_SLMG_JJ = {3000, 0.25, 2350};

    //  运动手套（★） | 双栖(久经沙场)
    public static double[] YD_SX_JJ = {2600, 0.25, 2100};

    //  运动手套（★） | 欧米伽(久经沙场)
    public static double[] YD_OMJ_JJ = {2200, 0.23, 1700};

    // 九头蛇手套（★） | 表面淬火(略有磨损)
    public static double[] JTS_BMCH_LM = {1800, 0.10, 1400};

    // 九头蛇手套（★） | 表面淬火(久经沙场)
    public static double[] JTS_BMCH_JJ = {950, 0.20, 800};

    // 九头蛇手套（★） | 翡翠色调(略有磨损)
    public static double[] JTS_FCSD_LM = {1700, 0.10, 1400};

    // 九头蛇手套（★） | 翡翠色调(久经沙场)
    public static double[] JTS_FCSD_JJ = {900, 0.17, 750};
